...
class EflagsMod(Enum):
    CF = (x86_const.X86_EFLAGS_SET_CF | x86_const.X86_EFLAGS_UNDEFINED_CF | x86_const.X86_EFLAGS_RESET_OF | x86_const.X86_EFLAGS_MODIFY_CF)
    OF = (x86_const.X86_EFLAGS_SET_OF | x86_const.X86_EFLAGS_UNDEFINED_OF | x86_const.X86_EFLAGS_RESET_OF | x86_const.X86_EFLAGS_MODIFY_OF)
    ZF = (x86_const.X86_EFLAGS_SET_ZF | x86_const.X86_EFLAGS_UNDEFINED_ZF | x86_const.X86_EFLAGS_RESET_ZF | x86_const.X86_EFLAGS_MODIFY_ZF)
    DF = (x86_const.X86_EFLAGS_SET_DF | x86_const.X86_EFLAGS_RESET_DF | x86_const.X86_EFLAGS_MODIFY_DF)
    SF = (x86_const.X86_EFLAGS_SET_SF | x86_const.X86_EFLAGS_UNDEFINED_SF | x86_const.X86_EFLAGS_RESET_SF | x86_const.X86_EFLAGS_MODIFY_SF)
    PF = (x86_const.X86_EFLAGS_SET_PF | x86_const.X86_EFLAGS_UNDEFINED_PF | x86_const.X86_EFLAGS_RESET_PF | x86_const.X86_EFLAGS_MODIFY_PF)
    AF = (x86_const.X86_EFLAGS_SET_AF | x86_const.X86_EFLAGS_UNDEFINED_AF | x86_const.X86_EFLAGS_RESET_AF | x86_const.X86_EFLAGS_MODIFY_AF)
...
ODI_FL_JCC = [
    EflagsMod.OF.value , EflagsMod.OF.value, # jo / jno
    EflagsMod.CF.value , EflagsMod.CF.value, # jb / jae
    EflagsMod.ZF.value , EflagsMod.ZF.value, # je / jne
    EflagsMod.ZF.value | EflagsMod.CF.value, EflagsMod.ZF.value | EflagsMod.CF.value, # jbe / jnbe
    EflagsMod.SF.value , EflagsMod.SF.value, # js / jns
    EflagsMod.PF.value , EflagsMod.PF.value,  # jp / jnp
    EflagsMod.OF.value | EflagsMod.SF.value, EflagsMod.OF.value | EflagsMod.SF.value, # jnge / jge
    EflagsMod.OF.value | EflagsMod.SF.value | EflagsMod.ZF.value, EflagsMod.OF.value | EflagsMod.SF.value | EflagsMod.ZF.value # jng / jnle
]
