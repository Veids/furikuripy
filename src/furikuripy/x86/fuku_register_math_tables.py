...
CAPSTONE_REGISTER_FLAGS = [
    -2,
    FlagRegister.AX, FlagRegister.AL, FlagRegister.AX, FlagRegister.BX, FlagRegister.BL,
    FlagRegister.BP, FlagRegister.BPL, FlagRegister.BX, FlagRegister.CX, FlagRegister.CL,
    -2, FlagRegister.CX, FlagRegister.DX, FlagRegister.DI, FlagRegister.DIL,
    FlagRegister.DL, -2, FlagRegister.DX, FlagRegister.EAX, FlagRegister.EBP,
    FlagRegister.EBX, FlagRegister.ECX, FlagRegister.EDI, FlagRegister.EDX, 0,
    -2, -2, -2, FlagRegister.ESI, FlagRegister.ESP,
    -2, -2, -2, -2, FlagRegister.RAX,
    FlagRegister.RBP, FlagRegister.RBX, FlagRegister.RCX, FlagRegister.RDI, FlagRegister.RDX,
    -2, -2, FlagRegister.RSI, FlagRegister.RSP, FlagRegister.SI,
    FlagRegister.SIL, FlagRegister.SP, FlagRegister.SPL, -2, -2,
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    ...
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    -2, FlagRegister.R8, FlagRegister.R9, FlagRegister.R10, FlagRegister.R11,
    FlagRegister.R12, FlagRegister.R13, FlagRegister.R14, FlagRegister.R15,
    -2, -2, -2, -2,
    -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    ...
    -2, -2, -2, -2, -2,
    -2, -2, -2, -2, -2,
    -2, FlagRegister.R8B, FlagRegister.R9B, FlagRegister.R10B, FlagRegister.R11B,
    FlagRegister.R12B, FlagRegister.R13B, FlagRegister.R14B, FlagRegister.R15B, FlagRegister.R8D,
    FlagRegister.R9D, FlagRegister.R10D, FlagRegister.R11D, FlagRegister.R12D, FlagRegister.R13D,
    FlagRegister.R14D, FlagRegister.R15D, FlagRegister.R8W, FlagRegister.R9W, FlagRegister.R10W,
    FlagRegister.R11W, FlagRegister.R12W, FlagRegister.R13W, FlagRegister.R14W, FlagRegister.R15W,
    -2
]
